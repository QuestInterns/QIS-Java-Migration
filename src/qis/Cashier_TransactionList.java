 ...
 * @author Windows 10
 */
public class Cashier_TransactionList extends javax.swing.JFrame {

    /**
     * Creates new form Frm_Login
     */
    public Cashier_TransactionList() {
        initComponents();
...
//                    System.exit(0);
    ...
    private void addColumns()
    {
        ...
        updated.addColumn("Transaction Type");
    ...
    private void search()
    {
        try
        {
            ...
            while(z<rows)
            {
                if(list.getValueAt(z, 0).toString().toLowerCase().contains(txtName.getText().toLowerCase()) || list.getValueAt(z, 1).toString().toLowerCase().contains(txtName.getText().toLowerCase()) || list.getValueAt(z, 2).toString().toLowerCase().contains(txtName.getText().toLowerCase()) || list.getValueAt(z, 3).toString().toLowerCase().contains(txtName.getText().toLowerCase()) || list.getValueAt(z, 4).toString().toLowerCase().contains(txtName.getText().toLowerCase()) || list.getValueAt(z, 5).toString().toLowerCase().contains(txtName.getText().toLowerCase()))
                {
    ...
    private void kButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton4ActionPerformed
        ...
        int option = fc.showSaveDialog(Cashier_TransactionList.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cashier_TransactionList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cashier_TransactionList().setVisible(true);
            }
        });
    }
